/**
 * Monitoring Service
 * Collects CPU and RAM usage metrics for the quiz application
 */
...
function calculateCpuUsage(): number {
  ...
  // Clamp to 0-100 and account for multiple cores
  return Math.min(100, Math.max(0, cpuUsagePercent * os.cpus().length));
}
